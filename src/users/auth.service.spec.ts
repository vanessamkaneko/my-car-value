...
describe('AuthService', () => {
    ...
    const module = await Test.createTestingModule({
      providers:
        [
          AuthService,
          {
            provide: UsersService, // if anyone asks for UsersService...
            useValue: fakeUsersService //...give them this object
          }
        ]
    }).compile();
  ...
  it('returns an user if correct password is provided', async () => {
    ...
    const user = await service.signin('test@test.com', 'newpassword')
